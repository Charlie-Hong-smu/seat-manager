...
| 自定义座位布局与分组拓扑 | 公共功能 | pending | 待晋升 | 保留八列四组默认布局；提供批量框选、孤立槽位、框选成组、组名编辑、讲台设置和吸附动画，编辑与解除兼容框选模式；行列边缘使用局部悬停淡绿加号/淡红减号，含座位删除须确认，插入不闪烁；新增和边缘扩展共用碰撞提示/确认，只转移相交座位，旧组收缩，断开区域自动拆组；组轮廓不重叠并避让讲台，排座读取相邻关系与分组关系 |
...
| 成绩排名补全与赋分兼容 | Zhang 先行 | pending | 未晋升 | 成绩导入由老师确认是否补齐缺失班排，保留原始分、赋分、既有班排和校排；每科展示排名，进退步统一按班排判断，旧成绩与备份继续兼容 |
| 多人事项与逐人跟进一致性 | Zhang 先行 | pending | 未晋升 | 共同事项一条待办关联多人，逐人作业/成绩/出勤/催缴继续独立；统一编辑、来源复用、历史、学生删除和持久化，历史拆分记录不自动合并 |
