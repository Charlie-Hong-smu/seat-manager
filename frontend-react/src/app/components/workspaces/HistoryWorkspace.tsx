...
const TONE_CLASS: Record<TimelineTone, string> = {
  normal: "border-accent-100 bg-accent-50 text-accent-600",
  reminder: "border-status-warning-100 bg-status-warning-50 text-status-warning-600",
  danger: "border-status-danger-100 bg-status-danger-50 text-status-danger-600",
  success: "border-status-success-100 bg-status-success-50 text-status-success-600",
  muted: "border-separator-border bg-background-secondary-default text-text-tertiary",
};
  ...
  return <div className="h-full overflow-y-auto bg-[var(--app-bg)] p-4">
    <div className="mx-auto max-w-6xl space-y-4">
      <div className="flex items-center justify-between gap-3">
        <div><h1 className="text-title-3-semibold text-[var(--app-text)]">历史</h1><p className="mt-1 text-caption-1-regular text-[var(--app-text-muted)]">回看班级动态，或管理已保存的座位快照。</p></div>
