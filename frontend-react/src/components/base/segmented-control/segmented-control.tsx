 ...
 *
 * Adapted to pressed-button group semantics; the ui.tsx wrapper enforces single selection that can't be
...
export function SegmentedControl({ className, children, variant = "solid", elementRef, ...props }: SegmentedControlProps) {
