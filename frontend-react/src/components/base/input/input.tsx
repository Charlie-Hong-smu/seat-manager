...
export function TextField({
  ...
  return (
    <TextFieldContext.Provider value={{ size, fieldClassName, inputClassName }}>
      <AriaTextField
        {...props}
        onKeyDown={props.onKeyDown ? event => { event.continuePropagation(); props.onKeyDown?.(event); } : undefined}
        onKeyUp={props.onKeyUp ? event => { event.continuePropagation(); props.onKeyUp?.(event); } : undefined}
    ...
    >
      {({ isRequired, isInvalid }) => (
        <>
          ...
          <InputBase
            data-autofocus={textFieldProps.autoFocus || undefined}
