...
- Removed legacy app: root `index.html`, `style.css`, `app.js`
...
2. Do not route new product work through the removed legacy root files: `index.html`, `style.css`, or `app.js`.
